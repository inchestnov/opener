...
func TestOpenError(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			action: Action{Strategy: StrategyCommand, Name: "open", Args: []string{target}},
			...
			wantSubstr: []string{"nothing knows how to open go.mod", "alias", "Finder"},
			wantNoRaw:  true,
		},
		{
		...
		},
		{
			...
			action:     Action{Strategy: StrategyApp, Name: "Preview", Args: []string{target}},
			stderr:     "",
